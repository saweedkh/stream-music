...
from apps.tracks.tracks.import_status.import_status_api import TrackImportStatusView
...
urlpatterns = [
    ...
    path("tracks/import/<str:task_id>/status", TrackImportStatusView.as_view()),
