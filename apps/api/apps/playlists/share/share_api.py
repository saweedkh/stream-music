...
from apps.playlists.playlists.playlist_serializers import PlaylistItemSerializer, PlaylistSerializer
...
class PlaylistSharePreviewView(APIView):
    ...
    def get(self, request, token: str):
        link = (
            PlaylistShareLink.objects.filter(token=token, is_active=True)
